...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/owasp-wstg-ja/flexsearch.min.js');loadScript('/owasp-wstg-ja/en.search-data.min.4d70a7a940f2811abfd9603d11268e77b067cd3e1d4bf64b78f19452a1643574.js',function(){input.required=false;search();});}
