...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.995bdd599bce2930abd252f96b95d2f0ff249b8b568cea706774878765932df0.js',function(){input.required=false;search();});}
