...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/owasp-wstg-ja/flexsearch.min.js');loadScript('/owasp-wstg-ja/ja.search-data.min.bafeea669c89fdef4aa208a83a37ccdd36820ee9c57d9625860deeb08b25abe4.js',function(){input.required=false;search();});}
