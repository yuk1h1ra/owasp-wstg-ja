...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c150a6da0bed976fdf684898a6976607de808bb5be1a4fe5ac53bdd50036d8cb.js',function(){input.required=false;search();});}
